...
function ahab_plugin_setting_mobile() {
	...
	if ( $options && array_key_exists( 'mobile', $options ) ) {
...
function ahab_plugin_setting_user_roles() {
	...
	foreach ( $wp_roles->roles as $role_key => $role ) {
		...
		if ( $options && ( array_key_exists( 'disabled_user_roles_' . $role_key, $options ) ) ) {
...
function ahab_plugin_setting_keyboard_shortcut() {
	...
	foreach ( $keyboard_shortcut_fields as $key => $value ) {
		if ( $options && ( array_key_exists( 'keyboard_shortcut_' . $key, $options ) ) ) {
	...
	$ahab_keyboard_shortcut_character = ( $options && array_key_exists( 'keyboard_shortcut_char', $options ) ) ? $options[ 'keyboard_shortcut_char' ] : '';
	?>
    <p>
